...
<div class="md-layout " >
<div class="md-layout md-flex-80 md-flex-small-100 " style="height: 100vh;">
  <div id="slider" class="slider">
    <?php $counter1=-1;  if( isset($images) && ( is_array($images) || $images instanceof Traversable ) && sizeof($images) ) foreach( $images as $key1 => $value1 ){ $counter1++; ?>
      <?php if( $counter1==0 ){ ?>
      <div slider-item active on-desktop="<?php echo $value1["src"]; ?>" on-small="<?php echo $value1["small"]; ?>" class="fadeInRight">

      </div>
      <?php }else{ ?>
      <div slider-item on-desktop="<?php echo $value1["src"]; ?>" on-small="<?php echo $value1["small"]; ?>"   class="fadeInRight">
